...
> This optional Filament 5 presentation package presents exactly one independent domain module. It contributes reusable resources, pages, widgets, schemas, tables, infolists, and actions to application-owned panels while delegating authorization, validation, tenancy, persistence, and business rules to the social-network-notifications public boundar
...
[![Latest release](https://img.shields.io/github/v/release/liberusoftware/module-social-network-notifications-filament?sort=semver)](https://github.com/liberusoftware/module-social-network-notifications-filament/releases/latest) [![Tests](https://github.com/liberusoftware/module-social-network-notifications-filament/actions/workflows/tests.yml/badge.svg?branch=main)](https://github.com/liberusoftware/module-social-network-notifications-filament/actions/workflows/tests.yml)
...
```bash
composer require liberusoftware/module-social-network-notifications-filament
```
...
<a href="https://github.com/liberusoftware/module-social-network-notifications-filament/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=liberusoftware/module-social-network-notifications-filament" alt="Contributors to liberusoftware/module-social-network-notifications-filament">
</a>

[View the full contributors graph](https://github.com/liberusoftware/module-social-network-notifications-filament/graphs/contributors).
